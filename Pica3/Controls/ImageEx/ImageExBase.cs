...
public abstract partial class ImageExBase : Control, IAlphaMaskProvider
{
    ...
    protected void AttachOnLoaded(RoutedEventHandler handler)
    {
        this.Loaded += handler;
    }

    protected void RemoveOnLoaded(RoutedEventHandler handler)
    {
        this.Loaded -= handler;
    }
    ...
    protected override void OnApplyTemplate()
    {
        ...
        RemoveOnLoaded(RetrySetSourceOnLoaded);
        ...
        if (RetryOnLoaded)
        {
            AttachOnLoaded(RetrySetSourceOnLoaded);
        }
